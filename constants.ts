...
export const TYPED_STRINGS = [
  "Verifica y autentica tus certificados",
  "Asegura la autenticidad de tus diplomas",
  "Valida de forma rápida y sencilla",
  "Confirma la veracidad de certificados",
  "Simplifica la validación académica",
  "Certificados auténticos y seguros",
];
